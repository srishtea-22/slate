    ...
    <>
      ...
      >
        <div
          ...
          onClick={collapse}
          className={cn(
            "h-6 w-6 rounded-sm text-muted-foreground opacity-0 group-hover/sidebar:opacity-100 hover:bg-neutral-300 dark:hover:bg-neutral-600 absolute top-3 right-2 transition",
